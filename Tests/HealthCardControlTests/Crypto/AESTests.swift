...
final class AESTests: XCTestCase {
    ...
    func testCMAC() {
        let key = try! Data(hex: "80E4BB520E28CB2FFCF4935AF938D540")
        let message = try! Data(hex: "7F494F060A04007F000702020402028641048C635FFD2DD40746D4A896040CC7FA161DFFA1EB" +
                "72C730E53F6781720F55B8DE16364ABB18C8604235151DDE7C4B80E64CA6AD17B7C941CD205003C9F6ED89AF")
        let expectedCMAC = try! Data(hex: "C9D0814E3B613A6A8111792741E712BC")

        expect {
            try AES.CMAC(key: key, data: message)
        } == expectedCMAC
    }
