...
extension HealthCardCommand {
    ...
    public struct Activate {
        ...
        public static func activateCurrentFile() -> HealthCardCommand {
            ...
            return try! DeActivateDeleteTerminate.alterCurrentFile()
                    .set(ins: ins)
                    .build()
        }
        ...
        public static func activate(privateOrSymmetricKey: Key, dfSpecific: Bool) -> HealthCardCommand {
            // swiftlint:disable:next force_try
            return try! DeActivateDeleteTerminate.alter(privateOrSymmetricKey: privateOrSymmetricKey,
        ...
        public static func activatePublicKey(reference: Data) throws -> HealthCardCommand {
            return try DeActivateDeleteTerminate.alterPublicKey(reference: reference)
                    .set(ins: ins)
                    .build()
        }
        ...
        public static func activate(password: Password, dfSpecific: Bool) -> HealthCardCommand {
            // swiftlint:disable:next force_try
            return try! DeActivateDeleteTerminate.alter(password: password, dfSpecific: dfSpecific)
                    .set(ins: ins)
                    .build()
        }
    }
    ...
    public struct Deactivate {
        ...
        public static func deactivate(privateOrSymmetricKey: Key, dfSpecific: Bool) -> HealthCardCommand {
            // swiftlint:disable:next force_try
            return try! DeActivateDeleteTerminate.alter(privateOrSymmetricKey: privateOrSymmetricKey, dfSpecific:
                    dfSpecific)
                    .set(ins: ins)
                    .build()
        }
