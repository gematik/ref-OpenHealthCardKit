...
extension HealthCardCommand {
    ...
    public struct SecurityStatus {
        ...
        private static let oidCvcFlCms = try! ObjectIdentifier.from(string: "{1.2.276.0.76.4.153}") //swiftlint:disable:this force_try line_length
        private static let oidCvcFlTi = try! ObjectIdentifier.from(string: "{1.2.276.0.76.4.152}")  //swiftlint:disable:this force_try line_length
